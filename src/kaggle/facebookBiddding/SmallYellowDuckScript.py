...
#bids, bot_or_human = load()
def load():
    bot_or_human = pd.read_csv('/home/dario/LogicalGlueDatasets/Facebook_bidding/datasets history/original data/train.csv')
    test = pd.read_csv('/home/dario/LogicalGlueDatasets/Facebook_bidding/datasets history/original data/test.csv')
    test['outcome'] = -1


    bids = pd.read_csv('/home/dario/LogicalGlueDatasets/Facebook_bidding/datasets history/original data/bids.csv')
