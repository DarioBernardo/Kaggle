...
def readTrainData():
    ...
    df = pd.read_csv("/home/dario/LogicalGlueDatasets/Facebook_bidding/train_dataset.csv", sep=",")
...
def readTestData():
    df = pd.read_csv("/home/dario/LogicalGlueDatasets/Facebook_bidding/test_dataset.csv", sep=",")
    print "Data frame shape: {}".format(df.shape)
